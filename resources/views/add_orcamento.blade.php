...
@section('content')
<div class="container">
    <h2 class="text-center my-4">Adicionar Orçamento</h2>
    <form id="form-orcamento" action="{{ route('adicionarorcamento') }}" method="POST">
...
<script>
    $(document).ready(function() {
        ...
        $('form#form-orcamento').submit(function(e) {
            e.preventDefault();
